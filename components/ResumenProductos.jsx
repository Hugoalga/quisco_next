  ...
  return (
    <div className=" shadow p-5 mb-3 flex gap-10 items-center">
        ...
        <div  className="md:w-4/6">
            ...
            <p className="text-xl text-amber-500 font-bold mt-2">Subtotal {formatearDinero(producto.precio * producto.cantidad)}</p>
        </div>

        <div>
            <button className="bg-sky-700 flex gap-2 px-5 py-2 text-white rounded-md w-full mb-5 text-align-center text-center"
            ...
            <button className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md w-full text-center"
